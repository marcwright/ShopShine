  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved size as @size" do
        ...
        post :create, {:size => { "name" => "invalid value" }}, valid_session
        assigns(:size).should be_a_new(Size)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested size" do
        ...
        Size.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => size.to_param, :size => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the size as @size" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Size.any_instance.stub(:save).and_return(false)
        put :update, {:id => size.to_param, :size => { "name" => "invalid value" }}, valid_session
        assigns(:size).should eq(size)
      end
